...
//функционал калькулятора для модальных окон
...
const forms = state => {
  ...
  const postData = async (url, data) => {
    //async и await нужны, чтобы js дождался ответа от сервера
...
"use strict";
__webpack_require__.r(__webpack_exports__);
//всплывающие при клике изображения
const images = () => {
...
const tabs = function (headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  //отслеживание нажатия пользователя
